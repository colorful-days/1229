...
class get_model(nn.Module):
    def __init__(self, num_classes):
        ...
        self.sa1 = PointNetSetAbstractionMsgAttention(1024, [0.05, 0.1], [16, 32], 9, [[16, 16, 32], [32, 32, 64]])
...
class get_loss(nn.Module):
    ...
    def forward(self, pred_logits, target, trans_feat, weight):
        ...
        varifocal_term = torch.where(target_one_hot == 1, (1 - pred_probs).pow(2), torch.tensor(0., device=pred_logits.device))
